...
module.exports = (sequelize, DataTypes) => {
  class properties_price_index_by_countries_2020 extends Model {
    /**
  ...
  properties_price_index_by_countries_2020.init({
    ...
    sequelize,
    modelName: 'properties_price_index_by_countries_2020',
    underscored: true,
  });
  return properties_price_index_by_countries_2020;
};