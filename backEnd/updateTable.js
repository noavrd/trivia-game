    ...
    case 2:
      let average2 =
        (read.rate1 +
          ...
          read.rate4 * 4 +
          read.rate5 * 5) /
        (read.rate1 + (read.rate2 + 1) + read.rate3 + read.rate4 + read.rate5);
    ...
    case 3:
      let average3 =
        (read.rate1 +
          ...
          read.rate4 * 4 +
          read.rate5 * 5) /
        (read.rate1 + read.rate2 + (read.rate3 + 1) + read.rate4 + read.rate5);
    ...
    case 4:
      let average4 =
        (read.rate1 +
          ...
          (read.rate4 + 1) * 4 +
          read.rate5 * 5) /
        (read.rate1 + read.rate2 + read.rate3 + (read.rate4 + 1) + read.rate5);
    ...
    case 5:
      let average5 =
        (read.rate1 +
          ...
          read.rate4 * 4 +
          (read.rate5 + 1) * 5) /
        (read.rate1 + read.rate2 + read.rate3 + read.rate4 + (read.rate5 + 1));
